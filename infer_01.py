...
def predict_dir_image(moder_dir, gpu_info, image_dir, res_dir, threshold):
    detector = Detector(
        model_dir, use_gpu=gpu_info)
...
if __name__ == '__main__':
    ...
    conf.read('detecion.conf')
    # 获取模型路径
    model_dir = conf.get("info", "models_dir")
    # 获取原图片路径和目标图片路径
    src_pic_dir_path = conf.get("info", "src_path")
    res_pic_dir_path = conf.get("info", "result_path")
    # 是否使用gpu
    gpu_info = conf.get("info", "use_gpu")
    # print(gpu_info)
    threshold = conf.get("info", "threshold")
    # print("model_dir:", model_dir)
    # print(src_pic_dir_path)
    # print(res_pic_dir_path)
    # print(gpu_info)
    # 预测多张图片
    # predict_dir_image(model_dir, gpu_info, src_pic_dir_path, res_pic_dir_path, threshold)
    # 预测单张图片
    # 创建预测实例
    detector = Detector(model_dir,use_gpu=bool(gpu_info))
